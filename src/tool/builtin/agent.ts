...
function buildAgentToolDescription(): string {
  ...
  return [
    ...
    "For complex or high-risk deliverables, consider launching a `verify` subagent near the end to independently inspect outputs, logs, key files, and unresolved errors before you answer.",
    "A verification subagent should be read-only and should critique the result; it should not continue implementation for the parent.",
    "",
    "Provide:",
