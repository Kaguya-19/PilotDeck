  ...
  return {
    ...
    description:
      [
        ...
        "For complex work, consider saving concise intermediate checkpoints to ordinary workspace files after exploration or major milestones: confirmed facts, assumptions to verify, partial results, draft outputs, or validation notes.",
        "File checkpoints should help recovery and final verification; keep them lightweight and avoid creating extra files for simple tasks that do not need cross-step memory.",
        "Use todo_write for session-level progress and file checkpoints for auditable intermediate state; they can complement each other, but neither replaces real tool execution or final validation.",
        ...
        "Prefer a final verification checkpoint that checks outputs, format, counts, extra artifacts, unhandled errors, side effects, and key constraints when applicable.",
