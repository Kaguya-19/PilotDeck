  ...
  switch (mode) {
    ...
    case "plan":
      return [
        ...
        "- write_file, edit_file (except .md files under the designated plan directory)",
        "- edit_notebook",
        ...
        "- write_file/edit_file ONLY for .md files under the designated plan directory",
        ...
        "4. Create or refine a markdown plan file under the designated plan directory",
        ...
        "- DO NOT call bash with write commands for any reason; use write_file/edit_file only for markdown plan files under the designated plan directory",
        "- You may use read-only tools freely, and you may write only markdown plan files under the designated plan directory while plan mode is active",
